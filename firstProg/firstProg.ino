...
#define EEPROM_D0 5            //Define pin 5 
#define EEPROM_D0 12           //Define pin 12 
//
...
/*
 * Here I create a method that will read the EEPROM!
 * 
 * @param int address - the data that we want to read from the EEPROM
 * @return byte -  
 */
 byte readEEPROM(int address){

   setAddress(address, /*outputEnable*/ true);    //Need to call setAddress() to actually set the address
 }
